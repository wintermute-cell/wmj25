...
# 1. Main Stroke: The center line
# 2. Splotches: Random particles around the stroke
# 3. Pools: Particles when moving very slowly
# 4. Lift Pools: Particles when releasing the brush slowly
...
func add_ink_splatter(
	...
	# when size_smoothing is higher (e.g. 0.2), gradual chnges
...
func _draw():
	...
	for point in ink_points:
		...
		if texture_to_use:
			...
			# texture should fit within a circle of diameter current_size * 2
